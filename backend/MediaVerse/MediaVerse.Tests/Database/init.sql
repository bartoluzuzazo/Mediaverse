...
ALTER TABLE album_music_genre
    ADD CONSTRAINT album_music_genre_album
...
ALTER TABLE album_music_genre
    ADD CONSTRAINT album_music_genre_music_genre
...
ALTER TABLE ama_session
    ADD CONSTRAINT ama_session_author
...
ALTER TABLE author
    ADD CONSTRAINT author_profile_picture
...
ALTER TABLE book_book_genre
    ADD CONSTRAINT book_book_genre_book
        FOREIGN KEY (book_id)
            REFERENCES book (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE book_book_genre
    ADD CONSTRAINT book_book_genre_book_genre
...
ALTER TABLE comment
    ADD CONSTRAINT comment_comment
...
ALTER TABLE entry
    ADD CONSTRAINT entry_cover_photo
...
ALTER TABLE friendship
    ADD CONSTRAINT friendship_user
        FOREIGN KEY (user_id)
            REFERENCES "user" (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE friendship
    ADD CONSTRAINT friendship_user2
...
ALTER TABLE game_developer
    ADD CONSTRAINT game_developer_developer
...
ALTER TABLE game_developer
    ADD CONSTRAINT game_developer_game
        FOREIGN KEY (game_id)
            REFERENCES game (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE game_game_genre
    ADD CONSTRAINT game_game_genre_game
        FOREIGN KEY (game_id)
            REFERENCES game (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE game_game_genre
    ADD CONSTRAINT game_game_genre_game_genre
...
ALTER TABLE movie_cinematic_genre
    ADD CONSTRAINT movie_cinematic_genre_cinematic_genre
...
ALTER TABLE movie_cinematic_genre
    ADD CONSTRAINT movie_cinematic_genre_movie
...
ALTER TABLE ama_question
    ADD CONSTRAINT question_ama_session
...
ALTER TABLE quiz_taking
    ADD CONSTRAINT quiz_taking_quiz
        FOREIGN KEY (quiz_id)
            REFERENCES quiz (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE quiz_taking
    ADD CONSTRAINT quiz_taking_user
        FOREIGN KEY (user_id)
            REFERENCES "user" (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE quiz_writing
    ADD CONSTRAINT quiz_writing_quiz
        FOREIGN KEY (quiz_id)
            REFERENCES quiz (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE quiz_writing
    ADD CONSTRAINT quiz_writing_user
        FOREIGN KEY (user_id)
            REFERENCES "user" (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE series_cinematic_genre
    ADD CONSTRAINT series_cinematic_genre_cinematic_genre
        FOREIGN KEY (cinematic_genre_id)
            REFERENCES cinematic_genre (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE series_cinematic_genre
    ADD CONSTRAINT series_cinematic_genre_series
        FOREIGN KEY (series_id)
            REFERENCES series (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE song_album
    ADD CONSTRAINT song_album_album
        FOREIGN KEY (album_id)
            REFERENCES album (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE song_album
    ADD CONSTRAINT song_album_song
        FOREIGN KEY (song_id)
            REFERENCES song (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE song_music_genre
    ADD CONSTRAINT song_music_genre_music_genre
        FOREIGN KEY (music_genre_id)
            REFERENCES music_genre (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE song_music_genre
    ADD CONSTRAINT song_music_genre_song
        FOREIGN KEY (song_id)
            REFERENCES song (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE "user"
    ADD CONSTRAINT user_profile_picture
        FOREIGN KEY (profile_picture_id)
            REFERENCES profile_picture (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE work_on
    ADD CONSTRAINT work_on_author_role
